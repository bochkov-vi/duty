...
MERGE INTO SHIFT_TYPE (ID_SHIFT_TYPE, SHIFT_TYPE, ICON, LABEL, CREATED_DATE)
    KEY (ID_SHIFT_TYPE)
    VALUES (0, 'Выходной', NULL, NULL, CURRENT_TIMESTAMP()),
           (1, 'Обычный рабочий день', NULL, NULL, CURRENT_TIMESTAMP()),
           (2, 'Рабочий день перед выходным', NULL, NULL, CURRENT_TIMESTAMP()),
           (3, 'Рабочий день после выходного', NULL, NULL, CURRENT_TIMESTAMP()),
           (4, 'ПОДКНО', NULL, 'X', CURRENT_TIMESTAMP()),
           (5, '30%', NULL, '30%', CURRENT_TIMESTAMP()),
           (6, 'ОД', NULL, 'ОД', CURRENT_TIMESTAMP())
;
...
MERGE INTO SHIFT_TYPE_PERIOD (ID_SHIFT_TYPE, START, DURATION)
    ...
    VALUES (1, '9:00:00', EXTRACT(EPOCH FROM time '13:00:00' - time '9:00:00') / 60),
           (1, '14:00:00', EXTRACT(EPOCH FROM time '18:00:00' - time '13:45:00') / 60),
           (2, '9:00:00', EXTRACT(EPOCH FROM time '13:00:00' - time '9:00:00') / 60),
           (2, '13:45:00', EXTRACT(EPOCH FROM time '16:45:00' - time '13:45:00') / 60),
           (3, '9:00:00', EXTRACT(EPOCH FROM time '13:00:00' - time '9:00:00') / 60),
           (3, '14:00:00', EXTRACT(EPOCH FROM time '18:00:00' - time '13:45:00') / 60),


           (4, '9:00:00', EXTRACT(epoch FROM INTERVAL '24' HOUR) / 60),
           (5, '9:00:00', EXTRACT(EPOCH FROM time '13:00:00' - time '9:00:00') / 60),
           (5, '13:45:00', EXTRACT(EPOCH FROM time '18:00:00' - time '13:45:00') / 60),
           (6, '9:00:00', EXTRACT(epoch FROM INTERVAL '25' HOUR) / 60)
;
...
merge into SHIFT_TYPE_DAYS_FROM_WEEKEND (ID_SHIFT_TYPE, DAYS_FROM_WEEKEND)
    KEY (ID_SHIFT_TYPE, DAYS_FROM_WEEKEND)
    VALUES (3, 1);
